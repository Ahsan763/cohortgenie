...
const COLORS = [
  "#00B5D4", "#2F80ED", "#9B51E0", "#F2994A", "#27AE60",
  "#EB5757", "#F2C94C", "#56CCF2", "#BB6BD9", "#6FCF97",
  "#219653", "#2D9CDB"
];

const CohortRetentionLineChart = ({ data }: { data: any[] }) => {
  ...
  const xAxisKey = data[0]?.month ? "month" : data[0]?.quarter ? "quarter" : "year";
        ...
        <LineChart data={data}>
          ...
          {uniqueKeys.map((key, idx) => (
            <Line
              ...
              dot={{ r: 5, fill: COLORS[idx % COLORS.length], stroke: "none" }}
