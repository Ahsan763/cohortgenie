  ...
  return (
    <Form className="space-y-[2.6vh]">
      ...
      <div className="space-y-[1.2vh]">
        ...
        <div className="flex items-center justify-between text-xs">
          <label className="flex items-center gap-2 text-primary-text">
            ...
            />
            <span>I have read and agree <Link href={"#"} className='text-[#9B6EEE] hover:underline'>Term&apos;s and conditions</Link> </span>
          </label>
        </div>
      </div>
      ...
      <p className="text-center text-sm text-secondary-text mt-[4vh]">
        ...
        <Link href="/login" className="text-[#9B6EEE] font-medium hover:underline">
          Login
        </Link>
      </p>
    </Form>
